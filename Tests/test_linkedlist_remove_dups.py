from CrackingTheCodingInterview.linkedlist_remove_dups import remove_dups, Node

def test_will_return_original_list_no_dups():
    # Arrange
    node_d = Node("D")
    node_e = Node("E")
    node_f = Node("F")
    ...
    # Act
    answer = remove_dups(head_a)

    # Assert
    assert answer == node_d

def test_will_return_list_of_one_all_dups():
    # Arrange
    node_d = Node("D")
    node_e = Node("D")
    node_f = Node("D")
